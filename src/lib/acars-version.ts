...
export const ACARS_VERSION = "7.0.21";
...
export const ACARS_RELEASE_NOTES = [
  "Release estable: 7.0.21.",
  "Finalize ACARS robustecido para coordenadas lat/lon validas, incluyendo posiciones en 0 grados sin descartes falsos.",
