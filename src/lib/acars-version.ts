...
export const ACARS_VERSION = "6.0.2";
...
export const ACARS_RELEASE_NOTES = [
  "UI premium blanca total — nuevo diseño en todas las vistas.",
  "InFlight: AGL, QNH, TREN LED y RADIO ACARS en tiempo real.",
  "Updater diferencial blindado — todos los usuarios reciben la actualizacion automaticamente.",
  "Perfiles operativos activos para FBW, Fenix, Headwind, iFly, PMDG, Horizons, E-Jets y Maddog.",
  "Release estable: 6.0.2.",
];
