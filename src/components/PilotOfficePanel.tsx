...
export default function PilotOfficePanel({
  ...
  useEffect(() => {
    ...
    async function loadCareerOffice() {
      ...
      const { data, error } = await callSecureRpc("pw_get_pilot_career_office", {
  ...
  function startAircraftTraining(aircraftTypeCode: unknown) {
    ...
    void runCareerAction(
      ...
      async () => {
        const response = await callSecureRpc("pw_start_aircraft_training", {
  ...
  function refreshAircraftTraining(aircraftTypeCode: unknown) {
    ...
    void runCareerAction(
      ...
      async () => {
        const response = await callSecureRpc("pw_refresh_pilot_aircraft_training", {
  ...
  function requestAircraftCheckride(aircraftTypeCode: unknown) {
    ...
    void runCareerAction(
      ...
      async () => {
        const response = await callSecureRpc("pw_request_aircraft_checkride", {
          p_aircraft_type_code: aircraftCode,
        });
        return response;
      },
  ...
  function requestPromotionCheckride() {
    void runCareerAction(
      ...
      async () => {
        const response = await callSecureRpc("pw_request_promotion_checkride");
        return response;
      },
    );
  }
